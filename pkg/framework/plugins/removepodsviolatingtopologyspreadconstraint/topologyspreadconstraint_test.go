...
func TestTopologySpreadConstraint(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			plugin, err := New(&componentconfig.RemovePodsViolatingTopologySpreadConstraintArgs{
				Namespaces:                 tc.strategy.Params.Namespaces,
				LabelSelector:              tc.strategy.Params.LabelSelector,
				IncludeSoftConstraints:     tc.strategy.Params.IncludeSoftConstraints,
				ThresholdPriority:          tc.strategy.Params.ThresholdPriority,
				ThresholdPriorityClassName: tc.strategy.Params.ThresholdPriorityClassName,
				NodeFit:                    tc.strategy.Params.NodeFit,
			}, handle)
			if err != nil {
